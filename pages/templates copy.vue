      ...
      <card>
        ...
        <div class="row">
          ...
          <div class="col-6">
            ...
            <div v-if="widgetType == 'sendNumber'">
              <base-input
...
export default {
  ...
  data() {
    ...
    editModalVisible: false, // Debe estar en false al inicio
      editForm: {
        name: "",
        description: "",
      },
      currentTemplateIndex: null, // Índice de la template que se está editando
  ...
  editTemplate(template, index) {
    this.editForm = { ...template }; // Carga los datos de la fila
    this.currentTemplateIndex = index;
    this.editModalVisible = true; // 🔥 Aquí activamos el modal
  },
  saveTemplateChanges() {
    if (this.currentTemplateIndex !== null) {
      this.templates[this.currentTemplateIndex] = { ...this.editForm };
    }
    this.editModalVisible = false; // 🔥 Aquí cerramos el modal
  },
